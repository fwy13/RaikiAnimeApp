            ...
            typeof url === "object"
                ...
                : {
                      url: url.includes("://")
                          ...
                          : "https" +
                            url +
                            (!isNative ? "#animevsub-vsub_uafirefox" : ""),
                      headers: {
...
async function postNative(
    ...
    const response = await (!isNative ? Http : CapacitorHttp).post({
        url: url + (!isNative ? "#animevsub-vsub_uachrome" : ""),
        headers: !isNative
            ? undefined
            : {
                  [String.fromCharCode(
...
async function httpPost(
    ...
    console.log("post: ", {
        url: url + "#animevsub-vsub_uachrome",
        data,
        headers,
    });
...
const get = !isNative ? httpGet : getNative;
const post = !isNative ? httpPost : postNative;
